...
<html lang="en">
    <head>
        ...
        <title>Air Quality | Sensor Website</title>
        ...
        <script type="module">
            ...
            var firebaseData = [['Waktu', 'Kualitas Udara']];
            onValue(refs, (snapshot) => {
            firebaseData = snapshot;
            drawChart();
            });
            function drawChart() {
                var temp = [['Waktu', 'Kualitas Udara']];
                firebaseData.forEach(child=>{
                        temp.push([child.val().TimeStamp, parseFloat(child.val().AirQuality)]);
                    });
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Grafik Kualitas Udara</h1>
                        <hr />
