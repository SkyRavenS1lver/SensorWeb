...
<html lang="en">
    <head>
        ...
        <title>Temperature | Sensor Website</title>
        ...
        <script type="module">
            ...
            var firebaseData = [['Waktu', 'Temperature']];
            onValue(refs, (snapshot) => {
            firebaseData = snapshot;
            drawChart();
            });
            function drawChart() {
                var temp = [['Waktu', 'Temperature']];
                firebaseData.forEach(child=>{
                        temp.push([child.val().TimeStamp, parseFloat(child.val().Temperature)]);
                    });
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Grafik Temperatur</h1>
                        <hr />
