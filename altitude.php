...
<html lang="en">
    <head>
        ...
        <title>Approx Altitude | Sensor Website</title>
        ...
        <script type="module">
            ...
            var firebaseData = [['Waktu', 'Approx Altitude']];
            onValue(refs, (snapshot) => {
            firebaseData = snapshot;
            drawChart();
            });
            function drawChart() {
                var temp = [['Waktu', 'Approx Altitude']];
                firebaseData.forEach(child=>{
                        temp.push([child.val().TimeStamp, parseFloat(child.val().ApproxAltitude)]);
                    });
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Grafik Altitude</h1>
                        <hr />
