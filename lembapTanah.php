...
<html lang="en">
    <head>
        ...
        <title>Persentase Kelembapan Tanah | Sensor Website</title>
        ...
        <script type="module">
            ...
            var firebaseData = [['Waktu', 'Persentase Kelembapan Tanah']];
            onValue(refs, (snapshot) => {
            firebaseData = snapshot;
            drawChart();
            });
            function drawChart() {
                var temp = [['Waktu', 'Persentase Kelembapan Tanah']];
                firebaseData.forEach(child=>{
                        temp.push([child.val().TimeStamp, parseFloat(child.val().PersentaseKelembapanTanah)]);
                    });
                var data = google.visualization.arrayToDataTable(temp);
                var options = {
                    title: 'Persentase Kelembapan Tanah',
                    curveType: 'function',
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Grafik Kelembapan Tanah</h1>
                        <hr />
