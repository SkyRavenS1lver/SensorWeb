...
<html lang="en">
    <head>
        ...
        <title>Pressure | Sensor Website</title>
        ...
        <script type="module">
            ...
            var firebaseData = [['Waktu', 'Tekanan Udara']];
            onValue(refs, (snapshot) => {
            firebaseData = snapshot;
            drawChart();
            });
            function drawChart() {
                var temp = [['Waktu', 'Tekanan Udara']];
                firebaseData.forEach(child=>{
                        temp.push([child.val().TimeStamp, parseFloat(child.val().Pressure)]);
                    });
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Grafik Tekanan Udara</h1>
                        <hr />
