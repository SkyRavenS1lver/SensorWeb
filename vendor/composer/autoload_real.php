...
class ComposerAutoloaderInit37997ec32bea5796850f40f6edc56ab8
{
    ...
    public static function getLoader()
    {
        ...
        $includeFiles = \Composer\Autoload\ComposerStaticInit37997ec32bea5796850f40f6edc56ab8::$files;
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire37997ec32bea5796850f40f6edc56ab8($fileIdentifier, $file);
        }
 ...
 * @return void
 */
function composerRequire37997ec32bea5796850f40f6edc56ab8($fileIdentifier, $file)
{
